...
def verify_certificate_file(certificate_file_name, transaction_id=None, options={}):
    with open(certificate_file_name, 'rb') as cert_fp:
        ...
        # print(certificate_model.certificate_json)

        result = {
          'recipient': certificate_model.certificate_json['recipientProfile'],
          'transaction_id': certificate_model.txid,
          'issued_on': certificate_model.certificate_json['issuedOn'],
